...
static const uint8_t CHANNEL_OFFSET_TAB[] =
  { (uint8_t) (DMA1_Channel1_BASE - DMA1_BASE), (uint8_t) (DMA1_Channel2_BASE
      - DMA1_BASE), (uint8_t) (DMA1_Channel3_BASE - DMA1_BASE),
      (uint8_t) (DMA1_Channel4_BASE - DMA1_BASE), (uint8_t) (DMA1_Channel5_BASE
	  - DMA1_BASE),
...
{
  return (
      (READ_BIT(((DMA_Channel_TypeDef *)((uint32_t)((uint32_t)DMAx + CHANNEL_OFFSET_TAB[Channel - 1U])))->CCR,
...
LL_DMA_SetDataLength (DMA_TypeDef *DMAx, uint32_t Channel, uint32_t NbData)
{
  MODIFY_REG(
      ((DMA_Channel_TypeDef* )((uint32_t )((uint32_t )DMAx
	  + CHANNEL_OFFSET_TAB[Channel - 1U])))->CNDTR,
 ...
 */
__STATIC_INLINE void
LL_DMA_ConfigAddresses (DMA_TypeDef *DMAx, uint32_t Channel,
...
LL_DMA_SetPeriphRequest (DMA_TypeDef *DMAx, uint32_t Channel, uint32_t Request)
{
  MODIFY_REG(
      ...
      DMA_CSELR_C1S << ((Channel - 1U) * 4U),
      Request << DMA_POSITION_CSELR_CXS);
}
